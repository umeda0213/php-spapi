...
> \Popsicle\Amazon\Model\GetPricingResponse getCompetitivePricing($marketplace_id, $item_type, $asins, $skus)
...
[**\Popsicle\Amazon\Model\GetPricingResponse**](../Model/GetPricingResponse.md)
...
# **getItemOffers**
> \Popsicle\Amazon\Model\GetOffersResponse getItemOffers($marketplace_id, $item_condition, $asin)
...
[**\Popsicle\Amazon\Model\GetOffersResponse**](../Model/GetOffersResponse.md)
...
# **getListingOffers**
> \Popsicle\Amazon\Model\GetOffersResponse getListingOffers($marketplace_id, $item_condition, $seller_sku)
...
# **getPricing**
> \Popsicle\Amazon\Model\GetPricingResponse getPricing($marketplace_id, $item_type, $asins, $skus, $item_condition)
