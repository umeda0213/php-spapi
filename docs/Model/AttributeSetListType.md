...
**cpu_speed** | [**\Popsicle\Amazon\Model\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional] 
**cpu_type** | **string** | The CPU type attribute of the item. | [optional] 
**creator** | [**\Popsicle\Amazon\Model\CreatorType[]**](CreatorType.md) | The creator attributes of the item. | [optional] 
...
**display_size** | [**\Popsicle\Amazon\Model\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional] 
...
**hard_disk_size** | [**\Popsicle\Amazon\Model\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional] 
...
**languages** | [**\Popsicle\Amazon\Model\LanguageType[]**](LanguageType.md) | The languages attribute of the item. | [optional] 
**legal_disclaimer** | **string** | The legal disclaimer attribute of the item. | [optional] 
**list_price** | [**\Popsicle\Amazon\Model\Price**](Price.md) |  | [optional] 
**manufacturer** | **string** | The manufacturer attribute of the item. | [optional] 
**manufacturer_maximum_age** | [**\Popsicle\Amazon\Model\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional] 
**manufacturer_minimum_age** | [**\Popsicle\Amazon\Model\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional] 
...
**maximum_resolution** | [**\Popsicle\Amazon\Model\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional] 
...
**optical_zoom** | [**\Popsicle\Amazon\Model\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional] 
**package_dimensions** | [**\Popsicle\Amazon\Model\DimensionType**](DimensionType.md) |  | [optional] 
...
**running_time** | [**\Popsicle\Amazon\Model\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional] 
...
**small_image** | [**\Popsicle\Amazon\Model\Image**](Image.md) |  | [optional] 
**studio** | **string** | The studio attribute of the item. | [optional] 
**subscription_length** | [**\Popsicle\Amazon\Model\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional] 
**system_memory_size** | [**\Popsicle\Amazon\Model\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional] 
...
**weee_tax_value** | [**\Popsicle\Amazon\Model\Price**](Price.md) |  | [optional] 
