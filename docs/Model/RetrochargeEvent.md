...
**base_tax** | [**\Popsicle\Amazon\Model\Currency**](Currency.md) |  | [optional] 
**shipping_tax** | [**\Popsicle\Amazon\Model\Currency**](Currency.md) |  | [optional] 
**marketplace_name** | **string** | The name of the marketplace where the retrocharge event occurred. | [optional] 
**retrocharge_tax_withheld_list** | [**\Popsicle\Amazon\Model\TaxWithheldComponentList**](TaxWithheldComponentList.md) |  | [optional] 
