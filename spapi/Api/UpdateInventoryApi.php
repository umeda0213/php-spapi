...
class UpdateInventoryApi
{
     ...
     *
     * @param  \Popsicle\Amazon\Model\SubmitInventoryUpdateRequest $body body (required)
     ...
     * @return \Popsicle\Amazon\Model\SubmitInventoryUpdateResponse
     */
     ...
     *
     * @param  \Popsicle\Amazon\Model\SubmitInventoryUpdateRequest $body (required)
     * @param  string $warehouse_id Identifier for the warehouse for which to update inventory. (required)
     *
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Popsicle\Amazon\Model\SubmitInventoryUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitInventoryUpdateWithHttpInfo($body, $warehouse_id)
    {
        $returnType = '\Popsicle\Amazon\Model\SubmitInventoryUpdateResponse';
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Popsicle\Amazon\Model\SubmitInventoryUpdateResponse',
