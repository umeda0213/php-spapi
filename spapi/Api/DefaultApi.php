...
class DefaultApi
{
     ...
     * @return \Popsicle\Amazon\Model\ListFinancialEventGroupsResponse
     */
     ...
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Popsicle\Amazon\Model\ListFinancialEventGroupsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Popsicle\Amazon\Model\ListFinancialEventGroupsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Popsicle\Amazon\Model\ListFinancialEventGroupsResponse',
     ...
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Popsicle\Amazon\Model\ListFinancialEventsResponse
     */
     ...
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Popsicle\Amazon\Model\ListFinancialEventsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Popsicle\Amazon\Model\ListFinancialEventsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Popsicle\Amazon\Model\ListFinancialEventsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
