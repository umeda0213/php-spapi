...
class ProductPricingApi
{
     ...
     *
     * @param  \Popsicle\Amazon\Model\ProductPricing\GetItemOffersBatchRequest $body body (required)
     *
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Popsicle\Amazon\Model\ProductPricing\GetItemOffersBatchResponse
     */
     ...
     *
     * @param  \Popsicle\Amazon\Model\ProductPricing\GetItemOffersBatchRequest $body (required)
     *
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Popsicle\Amazon\Model\ProductPricing\GetItemOffersBatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemOffersBatchWithHttpInfo($body)
    {
        $returnType = '\Popsicle\Amazon\Model\ProductPricing\GetItemOffersBatchResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Popsicle\Amazon\Model\ProductPricing\GetItemOffersBatchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Popsicle\Amazon\Model\ProductPricing\Errors',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Popsicle\Amazon\Model\ProductPricing\GetListingOffersBatchRequest $body body (required)
     *
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Popsicle\Amazon\Model\ProductPricing\GetListingOffersBatchResponse
     */
     ...
     *
     * @param  \Popsicle\Amazon\Model\ProductPricing\GetListingOffersBatchRequest $body (required)
     *
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Popsicle\Amazon\Model\ProductPricing\GetListingOffersBatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListingOffersBatchWithHttpInfo($body)
    {
        $returnType = '\Popsicle\Amazon\Model\ProductPricing\GetListingOffersBatchResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Popsicle\Amazon\Model\ProductPricing\GetListingOffersBatchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
