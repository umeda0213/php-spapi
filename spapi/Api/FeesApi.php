...
class FeesApi
{
     ...
     *
     * @param  \Popsicle\Amazon\Model\ProductFees\FeesEstimateByIdRequest[] $body body (required)
     *
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Popsicle\Amazon\Model\ProductFees\GetMyFeesEstimatesResponse
     */
     ...
     *
     * @param  \Popsicle\Amazon\Model\ProductFees\FeesEstimateByIdRequest[] $body (required)
     *
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Popsicle\Amazon\Model\ProductFees\GetMyFeesEstimatesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMyFeesEstimatesWithHttpInfo($body)
    {
        $returnType = '\Popsicle\Amazon\Model\ProductFees\GetMyFeesEstimatesResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Popsicle\Amazon\Model\ProductFees\GetMyFeesEstimatesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Popsicle\Amazon\Model\ProductFees\GetMyFeesEstimatesErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function getMyFeesEstimatesRequest($body)
    {
        ...
        if (isset($_tempBody)) {
            ...
            $httpBody = $_tempBody;
            // \stdClass has no __toString(), so we should encode it manually
            if ((is_array($httpBody) || $httpBody instanceof \stdClass) && $headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode($httpBody);
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
