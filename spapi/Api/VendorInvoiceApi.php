...
class VendorInvoiceApi
{
     ...
     *
     * @param  \Popsicle\Amazon\Model\SubmitInvoiceRequest $body body (required)
     *
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Popsicle\Amazon\Model\SubmitInvoiceResponse
     */
     ...
     *
     * @param  \Popsicle\Amazon\Model\SubmitInvoiceRequest $body (required)
     *
     * @throws \Popsicle\Amazon\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Popsicle\Amazon\Model\SubmitInvoiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitInvoiceWithHttpInfo($body)
    {
        $returnType = '\Popsicle\Amazon\Model\SubmitInvoiceResponse';
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Popsicle\Amazon\Model\SubmitInvoiceResponse',
