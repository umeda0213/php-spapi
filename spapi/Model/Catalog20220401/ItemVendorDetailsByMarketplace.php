...
'product_category' => '\Popsicle\Amazon\Model\Catalog20220401\ItemVendorDetailsCategory',
'product_group' => 'string',
'product_subcategory' => '\Popsicle\Amazon\Model\Catalog20220401\ItemVendorDetailsCategory',
...
self::REPLENISHMENT_CATEGORY_PLANNED_REPLENISHMENT,        ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['replenishment_category']) && !in_array($this->container['replenishment_category'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'replenishment_category', must be one of '%s'",
     ...
     * Sets brand_code
     *
     * @param string $brand_code Brand code associated with an Amazon catalog item.
     *
     * @return $this
     */
     ...
     *
     * @param string $manufacturer_code Manufacturer code associated with an Amazon catalog item.
     *
     * @return $this
     */
     ...
     *
     * @param string $manufacturer_code_parent Parent vendor code of the manufacturer code.
     *
     * @return $this
     */
     ...
     *
     * @return \Popsicle\Amazon\Model\Catalog20220401\ItemVendorDetailsCategory
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Catalog20220401\ItemVendorDetailsCategory $product_category product_category
     *
     * @return $this
     */
     ...
     * Sets product_group
     *
     * @param string $product_group Product group associated with an Amazon catalog item.
     *
     * @return $this
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Catalog20220401\ItemVendorDetailsCategory $product_subcategory product_subcategory
     *
     * @return $this
     */
     ...
     *
     * @param string $replenishment_category Replenishment category associated with an Amazon catalog item.
     *
     * @return $this
     */
