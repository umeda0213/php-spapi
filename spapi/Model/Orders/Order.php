...
'order_total' => '\Popsicle\Amazon\Model\Orders\Money',
'number_of_items_shipped' => 'int',
'number_of_items_unshipped' => 'int',
'payment_execution_detail' => '\Popsicle\Amazon\Model\Orders\PaymentExecutionDetailItemList',
'payment_method' => 'string',
'payment_method_details' => '\Popsicle\Amazon\Model\Orders\PaymentMethodDetailItemList',
'marketplace_id' => 'string',
'shipment_service_level_category' => 'string',
'easy_ship_shipment_status' => '\Popsicle\Amazon\Model\Orders\EasyShipShipmentStatus',
...
'is_sold_by_ab' => 'bool',
'is_iba' => 'bool',
'default_ship_from_location_address' => '\Popsicle\Amazon\Model\Orders\Address',
'buyer_invoice_preference' => 'string',
'buyer_tax_information' => '\Popsicle\Amazon\Model\Orders\BuyerTaxInformation',
'fulfillment_instruction' => '\Popsicle\Amazon\Model\Orders\FulfillmentInstruction',
'is_ispu' => 'bool',
'is_access_point_order' => 'bool',
'marketplace_tax_info' => '\Popsicle\Amazon\Model\Orders\MarketplaceTaxInfo',
'seller_display_name' => 'string',
'shipping_address' => '\Popsicle\Amazon\Model\Orders\Address',
'buyer_info' => '\Popsicle\Amazon\Model\Orders\BuyerInfo',
'automated_shipping_settings' => '\Popsicle\Amazon\Model\Orders\AutomatedShippingSettings',
'has_regulated_items' => 'bool',
'electronic_invoice_status' => '\Popsicle\Amazon\Model\Orders\ElectronicInvoiceStatus'    ];
...
self::BUYER_INVOICE_PREFERENCE_BUSINESS,        ];
     ...
     * Gets order_total
     *
     * @return \Popsicle\Amazon\Model\Orders\Money
     */
     ...
     * Sets order_total
     *
     * @param \Popsicle\Amazon\Model\Orders\Money $order_total order_total
     *
     * @return $this
     */
     ...
     *
     * @return \Popsicle\Amazon\Model\Orders\PaymentExecutionDetailItemList
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Orders\PaymentExecutionDetailItemList $payment_execution_detail payment_execution_detail
     *
     * @return $this
     */
     ...
     *
     * @return \Popsicle\Amazon\Model\Orders\PaymentMethodDetailItemList
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Orders\PaymentMethodDetailItemList $payment_method_details payment_method_details
     *
     * @return $this
     */
     ...
     *
     * @return \Popsicle\Amazon\Model\Orders\EasyShipShipmentStatus
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Orders\EasyShipShipmentStatus $easy_ship_shipment_status easy_ship_shipment_status
     *
     * @return $this
     */
     ...
     *
     * @param string $earliest_ship_date The start of the time period within which you have committed to ship the order. In ISO 8601 date time format. Returned only for seller-fulfilled orders.  __Note__: EarliestShipDate might not be returned for orders placed before February 1, 2013.
     *
     * @return $this
     */
     ...
     *
     * @param string $latest_ship_date The end of the time period within which you have committed to ship the order. In ISO 8601 date time format. Returned only for seller-fulfilled orders.  __Note__: LatestShipDate might not be returned for orders placed before February 1, 2013.
     *
     * @return $this
     */
     ...
     * Sets is_iba
     *
     * @param bool $is_iba When true, the item within this order was bought and re-sold by Amazon Business EU SARL (ABEU). By buying and instantly re-selling your items, ABEU becomes the seller of record, making your inventory available for sale to customers who would not otherwise purchase from a third-party seller.
     *
     * @return $this
     */
     ...
     *
     * @return \Popsicle\Amazon\Model\Orders\Address
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Orders\Address $default_ship_from_location_address default_ship_from_location_address
     *
     * @return $this
     */
     ...
     *
     * @param string $buyer_invoice_preference The buyer's invoicing preference. Available only in the TR marketplace.
     *
     * @return $this
     */
     ...
     *
     * @return \Popsicle\Amazon\Model\Orders\BuyerTaxInformation
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Orders\BuyerTaxInformation $buyer_tax_information buyer_tax_information
     *
     * @return $this
     */
     ...
     *
     * @return \Popsicle\Amazon\Model\Orders\FulfillmentInstruction
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Orders\FulfillmentInstruction $fulfillment_instruction fulfillment_instruction
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_access_point_order When true, this order is marked to be delivered to an Access Point. The access location is chosen by the customer. Access Points include Amazon Hub Lockers, Amazon Hub Counters, and pickup points operated by carriers.
     *
     * @return $this
     */
     ...
     *
     * @return \Popsicle\Amazon\Model\Orders\MarketplaceTaxInfo
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Orders\MarketplaceTaxInfo $marketplace_tax_info marketplace_tax_info
     *
     * @return $this
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Orders\Address $shipping_address shipping_address
     *
     * @return $this
     */
     ...
     * Gets buyer_info
     *
     * @return \Popsicle\Amazon\Model\Orders\BuyerInfo
     */
     ...
     * Sets buyer_info
     *
     * @param \Popsicle\Amazon\Model\Orders\BuyerInfo $buyer_info buyer_info
     *
     * @return $this
     */
     ...
     *
     * @return \Popsicle\Amazon\Model\Orders\AutomatedShippingSettings
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Orders\AutomatedShippingSettings $automated_shipping_settings automated_shipping_settings
     *
     * @return $this
     */
     ...
     *
     * @param bool $has_regulated_items Whether the order contains regulated items which may require additional approval steps before being fulfilled.
     *
     * @return $this
     */
     ...
     *
     * @return \Popsicle\Amazon\Model\Orders\ElectronicInvoiceStatus
     */
     ...
     *
     * @param \Popsicle\Amazon\Model\Orders\ElectronicInvoiceStatus $electronic_invoice_status electronic_invoice_status
     *
     * @return $this
     */
