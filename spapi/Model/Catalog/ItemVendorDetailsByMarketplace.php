...
self::REPLENISHMENT_CATEGORY_PLANNED_REPLENISHMENT,        ];
     ...
     * Sets category_code
     *
     * @param string $category_code Product category associated with an Amazon catalog item.
     *
     * @return $this
     */
     ...
     *
     * @param string $subcategory_code Product subcategory associated with an Amazon catalog item.
     *
     * @return $this
     */
